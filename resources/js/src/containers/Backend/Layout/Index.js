...
class Layout extends Component {
    ...
    render() {
        ...
        return <div className="Backend Layout text-left text-secondary">
            {isAuthenticated && <SideDrawer data={data} role={role} toggle={this.toggle} selectItem={this.selectItem} logoutHandler={this.logoutHandler} selectedItem={selectedItem} cms={cms} />}
